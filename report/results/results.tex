...
The design is sound, an has been implemented successfully before by the authors, but there was not enough time to fully implement it for this proect in the host code.
The following numbers are therefore harvested from from Silicon labs Simplicity studio energyAware Battery estimator.
