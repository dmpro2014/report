...
If it were to share clock with the rest of the system, the system clock would have to be \SI{25}{Mhz} itself or a multiplum thereof.
To avoid posing this limitation, the buffer in the HDMI unit crosses clock domains.
Since the buffer recieves data at native memory speed, it is filled faster than otherwise possible.
