...
\begin{table}[htp]
    ...
    \begin{tabular}{|p{8cm}|l|}
        \hline
        \textbf{GPU Functional Goals}                & \textbf{Priority} \\ \hline
        Computer should display graphics on screen                           & HIGH    \\ \hline
        Computer should be general purpose                                   & HIGH    \\ \hline
        Computer should drive video from FPGA                                & MEDIUM  \\ \hline
        Frame rate should be around 30 fps                                   & MEDIUM  \\ \hline
        Computer should use HDMI to display the graphics                     & MEDIUM  \\ \hline
        Computer should have an example application in form of a demo        & LOW     \\ \hline
        Computer should have a toolchain to make life easier for programmers & LOW     \\ \hline
    \end{tabular}
