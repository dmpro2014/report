...
This processor requires about three seconds to render one second of .
...
This makes the CPU very good at problems which display a low level of parallelism, but as problems get more parallel latency becomes less of a concern.
GPUs are optimized for problems with a high degree of parallelism.
Instead of prioritising latency for performance, GPUs focus on throughput.
