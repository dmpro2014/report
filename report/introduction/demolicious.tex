...
To be able to run a satisfactory demo, the group listed some basic requirements for Demolicious.
...
One very significant energy optimization for Demolicious made the list of functional goals: making the CPU sleep when it idles.
