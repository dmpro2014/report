...
Individual register files are selected by using the \textit{register file select signal}.
The control unit is responsible for selecting the correct register file. 
