...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\textwidth]{../gpu/diagrams/processor_core.png}
	\caption{A single processor core.}
	\label{fig:processor_core}
\end{figure}

Each processor core contains an ALU and a register directory.
The control unit controls the core by modifying control signals
...
%They consist of a single ALU, a register bank, as well as logic for reading operands from thred-private registers, shared external memory and constant storage.
