...
Below, in listing \ref{lst:green-kernel}, a kernel filling a framebuffer with green is written for Demolicious.
...
A masked instruction will not be stored to memory if the mask register is \textbf{1}.
