...
\todo{This sentence should be rewritten to explain what an assembler does and not focus on bonus features of the assembler}
...
\todo{Should we introduce calling a kernel multiple times in a loop?}

\todo{Should we show multiple kernels being loaded and executed in any order?}
