...
Due to a poor schematic in the clock component datasheet, the clock was wired incorrectly on the PCB, as illustrasted in figure \ref{fig:pcb-clock}.
...
This problem was solved by soldering together the pads of the SMD (surface mounted device\todo{move this definition earlier in the report}) capacitator to allow the clock signal to flow freely to the header pin.
