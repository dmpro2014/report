...
The reason for why this particular SRAM was chosen, was that to be able to output graphical demos, we need to be able to store frame buffers.\todo{Maybe explaine what a frame buffer is ?}
