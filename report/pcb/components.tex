...
The reasone for why this particular SRAM was chosen, was that to be able to output graphical demos we would need to be able to store fram buffers.\todo{Maybe explaine what a frame buffer is ?}
